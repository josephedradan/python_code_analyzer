...
class EventBorderEnd(EventBorder, ABC):
    ...
    def set_scope_part_of(self, scope_related: Scope):
        ...
        """
        If this object has no name because it's an EventBorderEnd to a EventBorderStart, then this object will have the
        same name as its EventBorderStart counterpart.
        """
